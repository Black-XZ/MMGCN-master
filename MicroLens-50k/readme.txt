In "MicroLens-50k_pairs.tsv", each row corresponds to a user ID, and the subsequent columns represent the video IDs that
...
Additionally, we also provide the interaction file for MicroLens-100k (namely "MicroLens-50k_pairs.csv"), in which 
